 ...
 */
/*Modified by NXP on 2026: added temperature sensor periodic read task*/
...
public:
	...
	void TemperatureMeasurementHandler(void);

private:
    static AppTask sAppTask;
	static void TemperatureMeasurementInternal(intptr_t arg);
    static void Temp_Sensor_Periodic_Read(void *arg);
};
} // namespace TemperatureSensorApp
